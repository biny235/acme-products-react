...
var _Changer = __webpack_require__(105);

var _Changer2 = _interopRequireDefault(_Changer);

var _reactRouterDom = __webpack_require__(76);

var _UpdateForm = __webpack_require__(56);

var _UpdateForm2 = _interopRequireDefault(_UpdateForm);

var _Handbag = __webpack_require__(106);

var _Handbag2 = _interopRequireDefault(_Handbag);
...
var Main = function (_React$Component) {
    ...
    _createClass(Main, [{
        ...
        value: function setProducts(products) {
            ...
            var specials = products.filter(function (product) {
                return product.isSpecial;
            });
            this.setState({ products: _products, specials: specials });
        }
    }, {
        key: 'getProducts',
        value: function getProducts() {
            ...
            _axios2.default.get('/api/products').then(function (response) {
                ...
                return _this2.setProducts(products);
            });
        }
    }, {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    specials.length,
                    ' Special',
                    specials.length > 1 || specials.length === 0 ? "s" : null
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_reactRouterDom.Route, { path: '/', exact: true, render: function render() {
                                return _react2.default.createElement(_Changer2.default, { getProducts: getProducts, products: products, specials: specials });
                            } }),
                        _react2.default.createElement(_reactRouterDom.Route, { path: '/newproduct', exact: true, render: function render() {
                                return _react2.default.createElement(_UpdateForm2.default, { getProducts: getProducts });
                            } }),
                        _react2.default.createElement(_reactRouterDom.Route, { path: '/handbag', exact: true, component: _Handbag2.default })
                    )
                )
            );
        }
...
var Form = function (_React$Component) {
    ...
    function Form() {
        ...
        _this.onChangePress = _this.onChangePress.bind(_this);
        _this.onUpdatePress = _this.onUpdatePress.bind(_this);
        return _this;
    }
    ...
    _createClass(Form, [{
        ...
        key: 'onChangePress',
        value: function onChangePress(ev) {
            ev.preventDefault();
        ...
        key: 'onUpdatePress',
        value: function onUpdatePress(ev) {
            ev.preventDefault();
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Selector2.default, { onChange: onSelect, products: products }),
                _react2.default.createElement(
                    'button',
                    { className: 'btn btn-success', disabled: selected === "", onClick: onChangePress },
                    'Change'
                ),
                _react2.default.createElement(
                    'button',
                    { className: 'btn btn-warning', disabled: selected === "", onClick: onUpdatePress },
                    'Update'
                )
            );
        }
...
var UpdateForm = function (_React$Component) {
    ...
    function UpdateForm() {
        ...
        var _this = _possibleConstructorReturn(this, (UpdateForm.__proto__ || Object.getPrototypeOf(UpdateForm)).call(this));
        ...
        _this.specialChange = _this.specialChange.bind(_this);
    ...
    _createClass(UpdateForm, [{
        ...
        key: 'specialChange',
        value: function specialChange(ev) {
        ...
        value: function createProduct(product) {
            ...
            _axios2.default.post('/api/products', { product: product }).then(function () {
        ...
        value: function render() {
            ...
            var onChange = this.onChange,
                ...
                specialChange = this.specialChange;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'form',
                    { onSubmit: onSubmit, className: 'form-group' },
                    _react2.default.createElement('input', { className: 'form-control', name: 'name', onChange: onChange, placeholder: 'Add new product' }),
                    _react2.default.createElement(
                        'select',
                        { onChange: specialChange, className: 'form-control' },
                        _react2.default.createElement(
                            'option',
                            { value: 'false' },
                            'Regular'
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_invariant__ = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_warning__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_warning___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_warning__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_invariant__ = __webpack_require__(59);
...
var Changer = function (_React$Component) {
    _inherits(Changer, _React$Component);

    function Changer() {
        _classCallCheck(this, Changer);

        var _this = _possibleConstructorReturn(this, (Changer.__proto__ || Object.getPrototypeOf(Changer)).call(this));

        _this.state = {
            products: [],
            specials: []
        };
        _this.changeSpecial = _this.changeSpecial.bind(_this);
        return _this;
    }

    _createClass(Changer, [{
        key: 'changeSpecial',
        value: function changeSpecial(id) {
            var _this2 = this;

            _axios2.default.patch('/api/products/' + id).then(function () {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_Form2.default, { 'function': changeSpecial, products: products })
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'col-xl-6' },
                        ...
                        _react2.default.createElement(_Form2.default, { 'function': changeSpecial, products: specials })
                    )
                )
            );
        }
...
var moveAlong = function moveAlong() {
    document.location.hash = '/';
};
var Handbag = function Handbag(id) {

    return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('iframe', { src: 'https://www.youtube.com/embed/oyuoUwxCLMs?rel=0&controls=0&showinfo=0' }),
        _react2.default.createElement(
            'button',
            { onClick: moveAlong },
            'Move Along'
