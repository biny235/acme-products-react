...
var Main = function (_React$Component) {
    ...
    function Main() {
        ...
        _this.productSelect = _this.productSelect.bind(_this);
        _this.specialSelect = _this.specialSelect.bind(_this);
    ...
    _createClass(Main, [{
        key: 'makeProduct',
        value: function makeProduct(ev) {
            ev.preventDefault();
            this.changeSpecial(this.state.selectedSpecial);
        }
    }, {
        key: 'makeSpecial',
        value: function makeSpecial(ev) {
            ev.preventDefault();
        ...
        key: 'productSelect',
        value: function productSelect(ev) {
            this.setState({
        ...
        key: 'specialSelect',
        value: function specialSelect(ev) {
            this.setState({
                products: this.state.products,
                specials: this.state.specials,
        ...
        value: function getProducts() {
            ...
            _axios2.default.get('/api/products').then(function (response) {
                ...
                return _this3.setProducts(products);
            });
        }
    }, {
        ...
        value: function render() {
            var _state = this.state,
                ...
                selectedSpecial = _state.selectedSpecial;
            var productSelect = this.productSelect,
                specialSelect = this.specialSelect,
                makeProduct = this.makeProduct,
                makeSpecial = this.makeSpecial;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_Form2.default, { onChange: productSelect, selectedProduct: selectedProduct, onClick: makeSpecial, products: products })
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'col-sm-6' },
                        ...
                        _react2.default.createElement(_Form2.default, { onChange: specialSelect, selectedProduct: selectedSpecial, onClick: makeProduct, products: specials })
                    )
                )
            );
        }
    ...
    _createClass(Form, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Selector2.default, { onChange: onChange, products: products }),
                _react2.default.createElement(
                    'button',
                    { className: 'btn btn-success', disabled: selectedProduct === "", onClick: onClick },
                    'Change'
                )
            );
        }
